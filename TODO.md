...
- [ ] **Outreach gate — fix the open n5-starter flags (46 as of 2026-08-22 evening)**: wife has now reviewed starter words 1–105 in deck order (72–105 done 2026-08-22: 11 ok, 22 new flags — mostly replacing unnatural「XはYです」sentences, with exact replacement JA+EN in her notes; plus クラス/晩御飯/毎晩 pitch). Original 24 (words 1–71) all still open, none fixed. Guests are locked to n5-starter; 10 new/day in file order; day 1 plays pool[0] sentence, day 2 pool[1]. Fix order: day-1/2 cluster first (7 flags in words 1–15: 母/父/兄/姉 register, 午後 sentence, 先生, 大学). Two kinds: sentence/gloss edits (deck JSON + tools/sentences-authored → publish-sentences → gen-audio → sync-audio-r2; new sentence ids auto-requeue for her re-check) and TTS pitch (`speak` overrides → gen-audio → R2). Mark each `reviews --fix`. Her remaining slice: words 106–121 (16 left). Outreach (listicles, dev.to) waits on this, NOT on N4/N3
